...
内容＝共创论框架（七命题/五大公理/三值/事件簿）+ 已记录的「事现」；事现记录是主功能，支持本地增删、SHA-256 哈希指纹、共识面板展示。
...
> 4. 应用内容为共创论框架推演与公开事现记录，标注为 BETA 测试版。
> 5. 联系：见官网 hygzz.cn。
